...
<body>
    ...
    <div class="container">
        ...
        <form action="process_login.php" method="post">
            <label for="username">VGH Username:</label>
            <input type="text" id="username" name="username" required placeholder = "Enter your VGH Number">
        ...
        <p class="register-link">Don't have an account? <a href="registration.php" style = "color: #049cb4;">Register</a></p>
    </section>
